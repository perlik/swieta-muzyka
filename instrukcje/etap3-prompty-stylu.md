...
**Obowiązkowy kadr psalmistki w każdym filmie (decyzja użytkownika, 2026-07, Psalm 46):** w każdym filmie umieszczać **dokładnie jeden kadr** z psalmistką w tym stylu (wzorzec: kadr 14 Psalmu 46) — duże zbliżenie na twarz wypełniające większość kadru, głowa w łagodnym obrocie 3/4 (widać przód i bok twarzy), długie włosy powiewające jakby na wietrze, miękka aureola z czystego złotego światła za głową (**bez skrzydeł**), wzrok skierowany wprost w kamerę mimo obróconej głowy, malowana miękko w tej samej akwarelowej, świetlistej stylistyce co reszta kadrów. Umieścić ten kadr tam, gdzie tekst danego psalmu najlepiej pasuje do wersu wypowiadanego wprost w pierwszej osobie (jak w Psalmie 46: „Uciszcie się, poznajcie, Ja jestem nad wami"). W tym jednym kadrze pomijać z negative promptu pozycje `face, facing camera, front view, detailed face, eye contact` oraz `angel, angelic figure, choir of angels` (reszta stałego negative promptu zostaje) — reszta kadrów filmu nadal trzyma się zakazu twarzy i zakazu aniołów bez wyjątku.
...
**Wybór kadru na miniaturę jest decyzją Etapu 3, nie Etapu 6 ani 7.** Podczas rozpisywania kadrów (Fable) wybrać jeden — najmocniejszy wizualnie, najlepiej z rozpoznawalnym motywem psalmu, czytelny w małym rozmiarze — i skomponować go pod miniaturę wg zasady wyżej („Kompozycja kadru-bazy miniatury"). Domyślny kandydat to kadr 1 (otwierający), ale wybrać inny, jeśli lepiej oddaje główny motyw/tytułowy hak psalmu.
